...
struct SubwayClient {
  var fetchTrainInfos: @Sendable (StationInfo?, String?) async throws -> [TrainInfo]
  ...
  func fetchTrainInfos(targetStation: StationInfo?, directionStationID: String?) async throws -> [TrainInfo] {
